        ...
        <div style={styles.container} aria-live="polite" aria-busy={loading}>
            ...
            {result && (
                <section style={styles.resultSection} aria-labelledby="result-title">
                    ...
                    <div className="result-content" style={styles.resultContent} dangerouslySetInnerHTML={renderMarkdown(result)} />
                </section>
            )}
        </div>
    );
...
const styles: { [key: string]: React.CSSProperties } = {
    ...
    resultHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #2a2a2a', paddingBottom: '12px', marginBottom: '12px' },
    resultTitle: { margin: 0, color: '#e0e0e0' },
    resultContent: { lineHeight: 1.7, wordWrap: 'break-word', color: '#d1d1d1' }
};
